		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<form id="frmEditArticle" action="{{ route('article-update') }}">
						<input type="hidden" id="id" name="id" value="{{ $data->id ?? ''}}">
							...
							<div class="submit-section">
								<button class="btn btn-primary submit-btn update-article" type="button">Update</button>
							</div>
						</form>
						<input type="hidden" id="articles-list" value="{{ route('articles') }}">
					</div>
				</div>
			</div>
		</div>
