		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<form id="frmEditCaseStudies" action="{{ route('case-studies-update') }}">
						<input type="hidden" id="id" name="id" value="{{ $data->id ?? ''}}">
							...
							<div class="submit-section">
								<button class="btn btn-primary submit-btn update-case-studies" type="button">Update</button>
							</div>
						</form>
						<input type="hidden" id="case-studies-list" value="{{ route('case-studies') }}">
					</div>
				</div>
			</div>
		</div>
