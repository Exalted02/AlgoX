			...
			<div class="row align-items-center">
				...
				<div class="col-md-8 float-end ms-auto">
					<div class="d-flex title-head">
						<a href="{{ route('market-tips-add') }}" class="btn add-btn"><i class="la la-plus-circle"></i> Add</a>
					</div>
				</div>
			</div>
		</div>
							...
							<tr>
								...
								<div class="dropdown dropdown-action">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="{{ route('market-tips-edit', $record->id) }}"><i class="fa-solid fa-pencil m-r-5"></i> {{ __('edit') }}</a>
											<a class="dropdown-item delete-market_tips text-danger" href="javascript:void(0);" data-id="{{ $record->id ?? '' }}" data-url="{{ route('market-tips-delete') }}"><i class="fa-regular fa-trash-can m-r-5"></i> {{ __('delete') }}</a>
										</div>
									</div>
								</td>
							</tr>
