		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<form id="frmAddMarketTips" action="{{ route('market-tips-create') }}">
						<input type="hidden" id="id" name="id" value="">
							...
							<div class="submit-section">
								<button class="btn btn-primary submit-btn save-market_tips" type="button">Submit</button>
							</div>
						</form>
						<input type="hidden" id="market_tips_list" value="{{ route('market-tips') }}">
					</div>
				</div>
			</div>
		</div>
